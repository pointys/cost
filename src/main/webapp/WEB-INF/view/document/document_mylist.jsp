        ...
        <table class="table table-hover table-condensed">
            ...
            <c:forEach items="${documentList}" var="document">
                <tr>
                    ...
                    <td align="center"><a href="${pageContext.request.contextPath}/document/documentWatch?file_id=${document.file_id}">预览</a></td>
                    <td align="center"><a href="${pageContext.request.contextPath}/document/documentDownload?file_id=${document.file_id}">下载</a></td>
                </tr>
            </c:forEach>
        </table>
    </div>
