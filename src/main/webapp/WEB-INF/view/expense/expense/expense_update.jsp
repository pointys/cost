		...
		<table class="table" id="tab1" >
			...
			<c:forEach items="${detailList }" var="detail">
				<tr>
					...
					<td>${detail.costId }
						<input type="hidden" name="costIds" value="${detail.costId }"/>
					</td>
					<td>${detail.costName }</td>
					<td>
					<input type='text' value='${detail.detailMoney }' id='money'  name='detailMoneys' class='form-control' style='width:100px'>
					</td>
					<td>
					<input type='text' name='detailDescs' value="${detail.detailDesc }" class='form-control'>
					</td>
					<td><a href='javascript:void(0)' class='btn btn-danger' onclick='del(this)' >删除</a></td>
				</tr>
