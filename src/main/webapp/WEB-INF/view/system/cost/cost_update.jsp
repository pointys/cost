...
<div>
    ...
    <!-- /：根目录webapps -->
<form action="/cost/system/costUpdate" id="f1" method="post" class="form-horizontal">
	<!-- action="system/costUpdate":什么都不写当前项目下system/costUpdate文件-->
<input type="hidden" name="costId" value="${cost.costId }"/>
		...
		<div class="row">
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="costName" value="${cost.costName }" placeholder="请输入费用名称" />
					</div>
				</div>
			</div>
			<div class="col-xs-9">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<textarea rows="" cols="" class="form-control" name="costDesc">${cost.costDesc }</textarea>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-xs-3 col-xs-offset-4">
				<input type="submit" class="btn btn-success" value="修改费用" /> <input
