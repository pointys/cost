...
<body>
	...
	<form action="system/myuserInfo" id="f1" method="post"
				...
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" required name="userName"
							value="${userInfo.userName }" placeholder="请输入用户姓名" />
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="userAge"
							value="${userInfo.userAge }" placeholder="请输入用户年龄" />
					</div>
				</div>
			</div>
		</div>
				...
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control" name="userPhone"
							value="${userInfo.userPhone }" placeholder="请输入电话号码" />
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-4 ">
						...
						<input type="hidden" name="roleName" value="${userInfo.roleName}">
					</div>
				</div>
			</div>
			<div class="col-xs-5">
				...
				<div class="form-group ">
					...
					<div class="col-xs-9 ">
						<input type="text" class="form-control"
							value="${userInfo.userPwd }" required name="userPwd"
							placeholder="请输入用户密码" />
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-xs-3 col-xs-offset-4">
				<input type="submit" class="btn btn-success" value="修改个人信息" onClick="if(!confirm('确认修改？'))return false;"/>
			</div>
