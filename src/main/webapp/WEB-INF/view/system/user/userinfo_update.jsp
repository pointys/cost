...
<form action="system/updateUser" id="f1" method="post" class="form-horizontal">
				...
				<div class="form-group ">
					...
					<div class="col-xs-4 ">
						<select name="roleId" class="form-control">
							<option value="1" ${user.roleId==1?'selected':'' }>普通员工</option>
							<option value="2" ${user.roleId==2?'selected':'' }>部门经理</option>
							<option value="3" ${user.roleId==3?'selected':'' }>财务人员</option>
							<option value="4" ${user.roleId==4?'selected':'' }>超级管理员</option>
						</select>
					</div>
				</div>
			</div>
		...
		<div class="row">
			<div class="col-xs-5">
				<div class="form-group ">
					...
					<div class="col-xs-9">
						<input type="text" class="form-control" required name="userAccount"  readonly="readonly" value="${user.userAccount }"  id="userAccount" placeholder="请输入用户账号" />
		...
		<div class="row">
			<div class="col-xs-3 col-xs-offset-4">
				<input type="submit" class="btn btn-success" value="修改用户" /> <input
