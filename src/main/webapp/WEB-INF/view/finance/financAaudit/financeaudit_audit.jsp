...
<body>
		...
		<table class="table" id="tab1" >
			...
			<c:forEach items="${recordList }" var="record">
				<tr>
					...
					<td><fmt:formatDate value="${record.auditDate}" pattern="yyyy年MM月dd日"/></td>
					<td>
	...
	<h5 class="page-header alert-info" style="margin: 0px; padding: 10px; margin-bottom: 10px;">财务审核</h5>
		...
		<div class="row">
			<div class="col-sm-7" align="center">
				...
				<a href="finance/queryFinanceExpense" class="btn btn-warning">返回上一级</a>
			</div>
		</div>
	</form>
